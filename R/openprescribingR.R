...
#' 
#' * drug_details(name = NULL, chemical_or_presentation_code = NULL, BNF_section_code = NULL, exact_name_or_code = NULL)
#' 
...
#' 
#' * spending_by_CCG(chemical_code = NULL, CCG_code = NULL)
#' 
