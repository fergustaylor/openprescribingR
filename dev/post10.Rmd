...
plot12.5 =  ggplot(ccggeom) +
  geom_polygon_interactive(data = ukdatapolygons, aes(x = long, y = lat, group = group, tooltip = label, fill = actual_cost)) +
  coord_sf(crs= 4326, datum = sf::st_crs(4326)) +
  scale_fill_gradientn(colours = pal) +
  labs(title="Actual_cost spending on 'BNF Section 7.4.5 Drugs'")
ggiraph(code = {print(plot12.5)}, width_svg = 17.07, height_svg = 13.46) %>%
...
plot12.5.5 =  ggplot(ccggeom) +
  ...
  scale_fill_gradientn(colours = pal) +
  labs(title="Actual_cost spending on 'BNF Section 7.4.5 Drugs'")
ggiraph(code = {print(plot12.5.5)}, width_svg = 17.07, height_svg = 13.46) %>%
